...
const arr2 = [1,2,3,4];
console.log(...arr2); // ... 전개연산자 = 1 2 3 4
...
// 객체 전개
const person = {name : 'khj', job : 'student'};
const khj = {...person, location : 'osan'}; //== const khj = {name:'khj', job:'student', location : 'osan'};
console.log(khj);
...
testRest('k','h','j',1,2,4); // 항상 배열 형태로 출력
testRest(...arr2);

// 비구조화 할당과, Rest Parameter
function testRest2 ({name, age, ...rest}){ // 비구조화 할당문법과 같이 사용해야함.
    console.log(name, age, rest);
}
const person2= {name : 'khj', age : '32', hobby:['game','movie'], location : 'osan'};
testRest2(person2);
