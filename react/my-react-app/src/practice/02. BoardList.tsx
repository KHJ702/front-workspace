          ...
          <tbody>
            {
                ...
                return (
                    ...
                    <td>
                        <button onClick={() => boardDelete(board.boardNo)}>삭제</button>
                    </td>
                    </tr>
                );
                })
